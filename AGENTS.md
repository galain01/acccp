...
| `GOTENBERG_URL` | For Word conversion | `lib/word-to-pdf.ts` | Worker HTTPS origin; HTTP loopback allowed only in local development. Direct PDF uploads do not use it. |
