...
async function preflightImages(bytes) {
  ...
  PDFContext.prototype.assign = function (ref, object) {
    ...
    assigned.add(key);
    if (assigned.size > MAX_PREFLIGHT_OBJECTS) fail("pdf_complexity_limit");
  ...
  try {
    document = await PDFDocument.load(bytes, {
      ...
      // pdf-lib's ES5 Error subclasses lose their type. Inspect its explicit
      // encryption flag immediately below, before any page access or rendering.
